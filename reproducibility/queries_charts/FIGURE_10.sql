-- #### FIGURE 10(a). The effects of storage architecture and scheduling policy on Matmul ####
SELECT
...
-- #### FIGURE 10(b). The effects of storage architecture and scheduling policy on K-means, 10 clusters ####
SELECT
	Y.VL_TOTAL_EXECUTION_TIME,
	Y.VL_INTER_TASK_EXECUTION_TIME AS VL_PARALLEL_TASK_TIME,
	Y.VL_INTRA_TASK_EXECUTION_TIME_FULL_FUNC AS VL_USER_CODE_TIME,
